 ...
 * 
 */
class ArtsCorps_Domain_FacilityContactList extends NPowerSeattle_Types_Collection {
     ...
     */
    public function add(ArtsCorps_Domain_FacilityContact $artist) {
        $this->doAdd($artist);
        $this->sortMe();
    }
    ...
    private function sortMe() {
        usort($this->objects, array("ArtsCorps_Domain_FacilityContactList", "cmp_obj"));
    }
